...
Points can be selected, and a selection moves as one.
...
- a drag on empty space draws a rubber band and selects what it covers; hold
...
```jsx
<PointsEditor.Root selection={selected} onSelectionChange={setSelected}>
```
