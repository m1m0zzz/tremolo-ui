...
const sidebars: SidebarsConfig = {
  ...
  tutorialSidebar: [
    ...
    },
    {
      type: 'category',
      label: 'Changelog',
      // The intro is the category's own page, so the label navigates to it.
      link: {
        type: 'doc',
        id: 'changelog/index',
      },
      items: [
        // ...and it is listed again as the first item, so that it can be
        // reached without knowing that the category label is a link. The
        // autogenerated list below leaves out whatever the category links to,
        // so naming it here adds one entry rather than duplicating it.
        'changelog/index',
        {
          type: 'autogenerated',
          dirName: 'changelog',
