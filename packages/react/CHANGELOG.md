...
- [#289](https://github.com/m1m0zzz/tremolo-ui/pull/289) [`fa26b76`](https://github.com/m1m0zzz/tremolo-ui/commit/fa26b76c804a83401ffc46f7c0c05931ef9376ed) Thanks [@m1m0zzz](https://github.com/m1m0zzz)! - `AnimationCanvas` forwards a ref to its `<canvas>` element.
...
- [#177](https://github.com/m1m0zzz/tremolo-ui/pull/177) [`c01b036`](https://github.com/m1m0zzz/tremolo-ui/commit/c01b036d80ce4e6a110d077c7893090fa1787437) Thanks [@m1m0zzz](https://github.com/m1m0zzz)! - `NumberInput.Root` takes `keepCaretOnStep`, which puts the caret in `InputField`
...
- [#169](https://github.com/m1m0zzz/tremolo-ui/pull/169) [`3e307df`](https://github.com/m1m0zzz/tremolo-ui/commit/3e307df8e6e42873f22dd6155a025d56fd697f4c) Thanks [@m1m0zzz](https://github.com/m1m0zzz)! - `NumberInput.Root` takes `unformatOnFocus`. With it set, `InputField` drops
...
- [#289](https://github.com/m1m0zzz/tremolo-ui/pull/289) [`fa26b76`](https://github.com/m1m0zzz/tremolo-ui/commit/fa26b76c804a83401ffc46f7c0c05931ef9376ed) Thanks [@m1m0zzz](https://github.com/m1m0zzz)! - Every exported props type now starts with the name of its component, so the list of types in `@tremolo-ui/react` says which component each one belongs to.
...
- [#284](https://github.com/m1m0zzz/tremolo-ui/pull/284) [`6302116`](https://github.com/m1m0zzz/tremolo-ui/commit/63021163f5df8304dd4db2b13adaef97c6b68e58) Thanks [@m1m0zzz](https://github.com/m1m0zzz)! - `NumberInput.InputField` no longer takes `selectOnFocus` or `blurOnEnter`. Set them on `NumberInput.Root`, which already holds `drag`, `dragSensitivity` and `pointerLock` for the `Stepper`. The parts keep only what belongs to their own element: `className`, `style`, `ref` and the rest of its attributes.
...
- [#288](https://github.com/m1m0zzz/tremolo-ui/pull/288) [`36a1c39`](https://github.com/m1m0zzz/tremolo-ui/commit/36a1c3920b6f15b8ccbe13e29efb18238dc398a1) Thanks [@m1m0zzz](https://github.com/m1m0zzz)! - `AnimationCanvas` and `Piano` now call following the size of the parent element `resizable`. `relativeSize` on `AnimationCanvas` and `fill` on `Piano` are gone.
...
- [#294](https://github.com/m1m0zzz/tremolo-ui/pull/294) [`b9aac34`](https://github.com/m1m0zzz/tremolo-ui/commit/b9aac3423046ba3002bfc5f1c85fe87cc1ab748d) Thanks [@m1m0zzz](https://github.com/m1m0zzz)! - Export the props types of `Knob.SVGRoot` and `Knob.Thumb` as `KnobSVGRootProps` and `KnobThumbProps`. `NumberInputIncrementStepperProps` and `NumberInputDecrementStepperProps` are now interfaces rather than aliases, so the API reference lists their props.
...
- [#230](https://github.com/m1m0zzz/tremolo-ui/pull/230) [`0718c20`](https://github.com/m1m0zzz/tremolo-ui/commit/0718c2005c7d9e67c24dae8f245269b51ff56194) Thanks [@m1m0zzz](https://github.com/m1m0zzz)! - Preserve custom Knob thumb classes, keep resizable Piano widths finite for ranges without white keys, and apply current dimensions when AnimationCanvas switches sizing modes.
