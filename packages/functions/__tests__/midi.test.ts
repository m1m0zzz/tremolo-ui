...
describe('unit test', () => {
  test('noteNumber()', () => {
    ...
    expect(noteNumber('A5')).toBe(69)
    expect(noteNumber('A#5')).toBe(70)
    expect(noteNumber('B5')).toBe(71)
    expect(noteNumber('Bbb5')).toBe(69)
    expect(noteNumber('A##5')).toBe(71)
